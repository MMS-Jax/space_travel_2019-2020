# Space Travel Calculator, Ryan Kelley, 02/19/20 4:02PM, Version 0.5
print("""
.▄▄ ·  ▄▄▄· ▄▄▄·  ▄▄· ▄▄▄ .                              
▐█ ▀. ▐█ ▄█▐█ ▀█ ▐█ ▌▪▀▄.▀·                              
▄▀▀▀█▄ ██▀·▄█▀▀█ ██ ▄▄▐▀▀▪▄                              
...
user_pick = int(input("Please make your choice."))
# print(user_pick)
...
if user_pick == 0:
    ...
    print("You did not choose an option from the menu.  The program will now exit.")
    exit() 

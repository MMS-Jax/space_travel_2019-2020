# Space Travel Calculator, Ryan Kelley, 03/05/20 10:08AM, Version 0.6
print("""
.▄▄ ·  ▄▄▄· ▄▄▄·  ▄▄· ▄▄▄ .                              
▐█ ▀. ▐█ ▄█▐█ ▀█ ▐█ ▌▪▀▄.▀·                              
▄▀▀▀█▄ ██▀·▄█▀▀█ ██ ▄▄▐▀▀▪▄                              
...
if menu_choice == 0:
    ...
    print("You did not select an object from the menu.")
    print("This program will now exit.  Please restart.")
    exit() 

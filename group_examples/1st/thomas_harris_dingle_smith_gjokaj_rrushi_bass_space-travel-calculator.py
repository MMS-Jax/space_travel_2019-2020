# Space Travel Calculator, Ryan Kelley, 02/26/20 10:28AM, Version 0.9
print("""
.▄▄ ·  ▄▄▄· ▄▄▄·  ▄▄· ▄▄▄ .                              
▐█ ▀. ▐█ ▄█▐█ ▀█ ▐█ ▌▪▀▄.▀·                              
▄▀▀▀█▄ ██▀·▄█▀▀█ ██ ▄▄▐▀▀▪▄                              
...
save_object = int(input("Please enter your choice."))
print(save_object)
...
speed = int(input("Please enter a speed in Km / s.  Do NOT enter commas or units."))
light_speed = 299792

if speed > light_speed:
    print("You cannot go faster than light: 299,792 Km / s.  Please try again.")
    speed = int(input("Please enter a speed in Km / s.  Do NOT enter commas or units."))
    if speed > light_speed:
        print("You are stupid and cannot read.  Please restart the program, loser.")
        exit()
    else:
        print("The speed you entered is",speed," Km / s.  That is acceptable.")
else:
        print("The speed you entered is",speed," Km / s.  That is acceptable.")       
...
max_travel = num_seconds_year * 3

# You need to write an if/else statment to compare trip_time to max_travel time.
# if it is greater, print a failure message.
